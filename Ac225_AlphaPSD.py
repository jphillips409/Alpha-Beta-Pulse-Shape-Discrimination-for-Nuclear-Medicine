...
def main():
    ...
    fitax_quad.hist(energy_filtA, bins=nbins, range=[0, 4095], label=r'$\alpha$ Events', alpha=0.8)
    fitax_quad.plot(xspace, QuadGaussFit(xspace, *E_param_quad), linewidth=2.5, label=r'4 Gaussian Fit')
    fitax_quad.plot(xspace, GaussFit(xspace, E_param_quad[0], E_param_quad[1], E_param_quad[2]), linewidth=2.5, label=r'$^{225}$Ac $\alpha$ fit')
    fitax_quad.plot(xspace, GaussFit(xspace, E_param_quad[3], E_param_quad[4], E_param_quad[5]), linewidth=2.5, label=r'$^{221}$Fr $\alpha$ fit')
    fitax_quad.plot(xspace, GaussFit(xspace, E_param_quad[6], E_param_quad[7], E_param_quad[8]), linewidth=2.5, label=r'$^{217}$At $\alpha$ fit')
   ...
   # plt.xlim([0,4095])
    ...
    if wavesdat is False:
        plt.savefig(r"C:\Users\j.s.phillips\Documents\Thorek_PSDCollab\Paper_Figures\Ac225_Stacked.eps", format='eps', dpi=300)
        plt.savefig(r"C:\Users\j.s.phillips\Documents\Thorek_PSDCollab\Paper_Figures\Ac225_Stacked.png", format='png', dpi=300)
        plt.savefig(r"C:\Users\j.s.phillips\Documents\Thorek_PSDCollab\Paper_Figures\Ac225_Stacked.svg", format='svg', dpi=300)
